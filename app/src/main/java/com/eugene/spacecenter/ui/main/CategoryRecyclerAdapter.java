...
public class CategoryRecyclerAdapter extends DataBoundListAdapter<Category,ListItemCategoryBinding> {
    ...
    @Override
    protected void bind(ListItemCategoryBinding binding, Category item) {binding.setCategory(item);}

    @Override
    protected boolean areItemsTheSame(Category oldItem, Category newItem) {return false;}
