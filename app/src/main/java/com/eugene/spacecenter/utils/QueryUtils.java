...
public final class QueryUtils {
    ...
    public static Apod fetchAPODData(String requestUrl) {
    ...
    private static Apod extractAPODDataFromJSON(String jsonResponse) {
        ...
        try {
            ...
            apod = new Apod(root.getString("date"),root.getString("explanation"),
